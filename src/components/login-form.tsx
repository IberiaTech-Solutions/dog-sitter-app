    ...
    <div className="rounded-xl bg-white p-8 shadow-sm">
      ...
      <div className="mt-6">
        ...
        <button
          ...
          className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg border border-zinc-300 py-2.5 text-sm font-medium text-zinc-700 hover:bg-zinc-50"
        >
