...
export default function SittersRecruitmentPage() {
  ...
  return (
    ...
    <div className="flex flex-col min-h-screen bg-canvas">
      ...
      <PublicHeader showSittersLink={false} />
